...
public partial class MainWindow : Window
{
    ...
    private static Dictionary<string, SubMenuConfig> BuildMenuConfigs()
    {
        return new Dictionary<string, SubMenuConfig>
        {
            ...
            ["reports_sales_register"] = C("Reports", "Sales Register", "Detailed sales by invoice/POS with tax and payment mode.", "Sales Register Filters", "Sales Register Output", F("Report No", "Period", "Status", "Branch", "As On Date", "Total Sales"), D("SRPT-", "", "Draft", "Main"), O("Draft", "Generated"), R(new HistoryRow("SRPT-12", "Feb-2026", "2026-02-24", "Generated", "$54,820"), new HistoryRow("SRPT-11", "Jan-2026", "2026-01-31", "Generated", "$49,310"), new HistoryRow("SRPT-10", "Dec-2025", "2025-12-31", "Generated", "$46,900")), "NXERP PHARMACY - SALES REGISTER\nMade by Noshahi Developers Inc\nPeriod: 01-Feb-2026 to 24-Feb-2026    Branch: Main Store\n-------------------------------------------------------------------------------\nDate       Invoice    Customer        Item              Qty   Net    Tax   Gross\n24-02-26   INV-9025   City Clinic     Amoxiclav 625      20   980   117   1097\n24-02-26   POS-4401   Walk-In         Panadol 500        12    80     6     86\n24-02-26   INV-9026   Care Home       NS 500ml           40  1260   151   1411\n-------------------------------------------------------------------------------\nTotal Net: 2320      Total Tax: 274      Total Gross: 2594\nPrepared By: __________  Checked By: __________  Authorized Sign: __________\n"),
            ["reports_purchase_register"] = C("Reports", "Purchase Register", "Purchase register with supplier, invoice, tax and payable status.", "Purchase Register Filters", "Purchase Register Output", F("Report No", "Period", "Status", "Branch", "As On Date", "Total Purchase"), D("PRPT-", "", "Draft", "Main"), O("Draft", "Generated"), R(new HistoryRow("PRPT-08", "Feb-2026", "2026-02-24", "Generated", "$28,400"), new HistoryRow("PRPT-07", "Jan-2026", "2026-01-31", "Generated", "$25,220"), new HistoryRow("PRPT-06", "Dec-2025", "2025-12-31", "Generated", "$23,990")), "NXERP PHARMACY - PURCHASE REGISTER\nMade by Noshahi Developers Inc\nPeriod: 01-Feb-2026 to 24-Feb-2026    Branch: Main Store\n-------------------------------------------------------------------------------\nDate       PINV No    Supplier            Base    Tax    Discount   Net Payable\n24-02-26   PINV-440   HealthLine Pharma   1750    210      10         1950\n23-02-26   PINV-439   Global Medics       1095    131       6         1220\n22-02-26   PINV-438   Sterile Supply Co    620     74       4          690\n-------------------------------------------------------------------------------\nTotal Base: 3465    Total Tax: 415    Total Net Payable: 3860\nPrepared By: __________  Store Incharge: __________  Authorized Sign: _________\n"),
            ["reports_stock_valuation"] = C("Reports", "Stock Valuation", "Current stock valuation by batch, expiry and moving average cost.", "Stock Valuation Filters", "Stock Valuation Output", F("Report No", "Store", "Status", "Method", "As On Date", "Stock Value"), D("SV-", "Main Store", "Draft", "Moving Avg"), O("Draft", "Generated"), R(new HistoryRow("SV-17", "Main Store", "2026-02-24", "Generated", "$73,990"), new HistoryRow("SV-16", "Main Store", "2026-02-23", "Generated", "$72,410"), new HistoryRow("SV-15", "Main Store", "2026-02-22", "Generated", "$71,860")), "NXERP PHARMACY - STOCK VALUATION REPORT\nMade by Noshahi Developers Inc\nAs On Date: 24-Feb-2026   Method: Moving Average\n-------------------------------------------------------------------------------\nProduct            Batch      Expiry      Qty    Avg Cost   Stock Value\nAmoxiclav 625      B-AX23     31-01-2027   125      3.80        475.00\nNS 500ml           B-NS91     15-11-2026   320      1.15        368.00\nPanadol 500        B-PN40     10-03-2027   860      0.38        326.80\n-------------------------------------------------------------------------------\nGrand Stock Value: 73,990.00\nPrepared By: __________  Store Verification: __________  Approved By: _________\n"),
            ["reports_expiry_report"] = C("Reports", "Expiry Report", "Near-expiry and expired stock for disposal planning.", "Expiry Report Filters", "Expiry Report Output", F("Report No", "Window", "Status", "Store", "As On Date", "Affected Qty"), D("ER-", "30 days", "Draft", "Main"), O("Draft", "Generated"), R(new HistoryRow("ER-09", "30 days", "2026-02-24", "Generated", "320"), new HistoryRow("ER-08", "60 days", "2026-02-24", "Generated", "640"), new HistoryRow("ER-07", "90 days", "2026-02-24", "Generated", "980")), "NXERP PHARMACY - EXPIRY ALERT REPORT\nMade by Noshahi Developers Inc\nWindow: Next 60 Days    Store: Main Store    Run Date: 24-Feb-2026\n-------------------------------------------------------------------------------\nProduct            Batch      Expiry Date   Days Left   Qty   Action\nCefixime 200       B-CF17     28-03-2026        33      60   Priority Sale\nNS 500ml           B-NS91     15-04-2026        51      80   Promo Offer\nCough Syrup        B-CS10     10-05-2026        76      40   Routine Monitor\n-------------------------------------------------------------------------------\nItems in 30 days: 12   Items in 60 days: 34   Items in 90 days: 57\nPrepared By: __________  QA Pharmacist: __________  Approved By: _____________\n"),
            ["reports_profit_loss"] = C("Reports", "Profit & Loss", "P&L statement with sales, COGS, gross profit and operating expenses.", "P&L Filters", "P&L Output", F("Report No", "Period", "Status", "Branch", "As On Date", "Net Profit"), D("PL-", "", "Draft", "Main"), O("Draft", "Generated"), R(new HistoryRow("PL-05", "Feb-2026", "2026-02-24", "Generated", "$12,800"), new HistoryRow("PL-04", "Jan-2026", "2026-01-31", "Generated", "$11,920"), new HistoryRow("PL-03", "Dec-2025", "2025-12-31", "Generated", "$10,740")), "NXERP PHARMACY - PROFIT AND LOSS STATEMENT\nMade by Noshahi Developers Inc\nPeriod: 01-Feb-2026 to 24-Feb-2026\n-------------------------------------------------------------------------------\nRevenue\n  Sales Revenue                                     54,820.00\nLess: Cost of Goods Sold                            37,640.00\n-------------------------------------------------------------------------------\nGross Profit                                        17,180.00\nOperating Expenses\n  Salaries                                            1,950.00\n  Electricity                                           520.00\n  Internet                                              210.00\n  Misc Expenses                                        1,700.00\n-------------------------------------------------------------------------------\nNet Profit                                          12,800.00\nPrepared By: __________  Finance Manager: __________  Director Sign: __________\n"),
            ["reports_trial_balance"] = C("Reports", "Trial Balance", "Trial balance with debit/credit totals for closing checks.", "TB Filters", "TB Output", F("Report No", "Period", "Status", "Branch", "As On Date", "Difference"), D("TB-", "", "Draft", "Main"), O("Draft", "Generated"), R(new HistoryRow("TB-078", "Feb-2026", "2026-02-24", "Generated", "$0"), new HistoryRow("TB-077", "Jan-2026", "2026-01-31", "Generated", "$0"), new HistoryRow("TB-076", "Dec-2025", "2025-12-31", "Generated", "$0")), "NXERP PHARMACY - TRIAL BALANCE\nMade by Noshahi Developers Inc\nAs On Date: 24-Feb-2026\n-------------------------------------------------------------------------------\nAccount Code   Account Name                 Debit         Credit\nAC-11001       MAIN CASH                    6,300.00         0.00\nAC-12010       CITY CLINIC A/R              1,240.00         0.00\nAC-21020       HEALTHLINE A/P                  0.00       1,950.00\nAC-41010       SALES REVENUE                   0.00      54,820.00\nAC-51010       COGS                        37,640.00         0.00\n-------------------------------------------------------------------------------\nTotal                                        45,180.00    45,180.00\nDifference: 0.00\nPrepared By: __________  Reviewer: __________  Approved By: __________\n"),
            ["reports_ledger"] = C("Reports", "Ledger Report", "Account and party ledger statement with running balance.", "Ledger Filters", "Ledger Output", F("Report No", "Account", "Status", "Period", "As On Date", "Closing Balance"), D("LR-", "MAIN CASH", "Draft"), O("Draft", "Generated"), R(new HistoryRow("LR-22", "MAIN CASH", "2026-02-24", "Generated", "$6,300"), new HistoryRow("LR-21", "CITY CLINIC A/R", "2026-02-24", "Generated", "$1,240"), new HistoryRow("LR-20", "HEALTHLINE A/P", "2026-02-24", "Generated", "$1,950")), "NXERP PHARMACY - LEDGER REPORT\nMade by Noshahi Developers Inc\nAccount: MAIN CASH   Period: Feb-2026\n-------------------------------------------------------------------------------\nDate       Voucher     Narration                      Dr        Cr      Balance\n01-02-26   OPN-001     Opening Balance              5,200.00    0.00   5,200.00\n12-02-26   POS-4360    Cash Sale Collection           860.00    0.00   6,060.00\n18-02-26   EV-329      Internet Expense                0.00   210.00   5,850.00\n24-02-26   RV-410      Receipt from City Clinic       900.00    0.00   6,750.00\n24-02-26   PV-510      Payment to HealthLine           0.00   450.00   6,300.00\n-------------------------------------------------------------------------------\nClosing Balance: 6,300.00\nPrepared By: __________  Accountant: __________  Approved By: __________\n"),
            ["reports_invoice_print"] = C("Reports", "Invoice Print Format", "Formatted retail and tax invoice templates.", "Invoice Template", "Invoice Template History", F("Template Code", "Template Name", "Status", "Paper Size", "Effective Date", "Copies"), D("TPL-INV-", "", "Draft", "A5", "", "1"), O("Draft", "Active"), R(new HistoryRow("TPL-INV-01", "Pharmacy Tax Invoice", "2026-02-24", "Active", "1"), new HistoryRow("TPL-INV-02", "POS Short Invoice", "2026-02-24", "Active", "1"), new HistoryRow("TPL-INV-03", "Institution Invoice", "2026-02-24", "Draft", "2")), "NXERP PHARMACY - TAX INVOICE TEMPLATE\nMade by Noshahi Developers Inc\n-------------------------------------------------------------------------------\nInvoice No: INV-9025                 Date: 24-Feb-2026\nCustomer  : City Clinic              NTN : 1234567-8\nAddress   : Main Boulevard, City\n-------------------------------------------------------------------------------\nItem Code    Description        Batch     Expiry    Qty   Rate   Tax   Amount\nMED-9001     Amoxiclav 625      B-AX23    31-01-27   20   49.00  5%    1029.00\nMED-9002     NS 500ml           B-NS91    15-11-26   15   14.00  5%     220.50\n-------------------------------------------------------------------------------\nSub Total: 1,190.00   Tax: 59.50   Net Total: 1,249.50\nPayment Terms: 15 Days\nPrepared By: __________  Received By: __________  Authorized Sign: __________\n"),
            ["reports_voucher_print"] = C("Reports", "Voucher Print Format", "Receipt, payment, journal and expense voucher templates.", "Voucher Template", "Voucher Template History", F("Template Code", "Voucher Type", "Status", "Paper Size", "Effective Date", "Copies"), D("TPL-VCH-", "Receipt", "Draft", "A5", "", "1"), O("Draft", "Active"), R(new HistoryRow("TPL-VCH-01", "Receipt Voucher", "2026-02-24", "Active", "1"), new HistoryRow("TPL-VCH-02", "Payment Voucher", "2026-02-24", "Active", "1"), new HistoryRow("TPL-VCH-03", "Journal Voucher", "2026-02-24", "Draft", "1")), "NXERP PHARMACY - RECEIPT VOUCHER TEMPLATE\nMade by Noshahi Developers Inc\n-------------------------------------------------------------------------------\nVoucher No: RV-410                  Date: 24-Feb-2026\nReceived From: City Clinic\nMode: Cash / MAIN CASH\n-------------------------------------------------------------------------------\nAccount Head                    Dr            Cr\nMAIN CASH                    900.00          0.00\nCITY CLINIC A/R                0.00        900.00\n-------------------------------------------------------------------------------\nNarration: Received outstanding against INV-9025.\nPrepared By: __________  Checked By: __________  Approved By: __________\n")
        };
    }
